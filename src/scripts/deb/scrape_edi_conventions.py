...
DTEB_URL = "https://www.ustranscom.mil/cmd/associated/dteb/dod-transportation.cfm"
...
def scrape_edi_conventions(url, delay=0):
    """
    Scrape EDI conventions and their PDF links from USTRANSCOM page.
    
    Args:
        url: The webpage URL to scrape
        delay: Optional delay in seconds between requests (for rate limiting)
    """
    ...
    print("✓ Saved to: dteb_edi_conventions.txt")
...
if __name__ == "__main__":
    ...
    try:
        conventions = scrape_edi_conventions(DTEB_URL, delay=0)
